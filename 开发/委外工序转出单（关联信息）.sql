...
u1.FTranOutQty as 'fssl',u1.FBatchNo as 'wlph',convert(char(10),u1.FFetchDate,120) as 'jhrq',t4.FName as 'jgdw',isnull(w.FQty,0) as 'sjsl',convert(char(10),w.FDate,120) as 'sjrq',u1.FQualifiedQty as 'hgsl',convert(char(10),z.FDate,120) as 'jyrq',u1.FReceiptQty as 'jssl',w.dj,u1.FTranOutQty*w.dj as 'je',convert(char(10),y.FDate,120) as 'jsrq',
...
LEFT JOIN (select FSourceInterID,FSourceEntryID,sum(FQty) as FQty,min(FDate) as FDate,max(dj) as dj from rss.dbo.wwzc_wwjysqd group by FSourceInterID,FSourceEntryID) w on w.FSourceInterID=u1.FInterID and w.FSourceEntryID=u1.FEntryID
...
or t4.FName like '%'+@query+'%' or t4.FNumber like '%'+@query+'%')
end
...
exec table_wwzc '','2015-01-01','2015-03-31'

exec table_wwzc '01.177','2015-01-01','2015-03-31'
exec table_wwzc '01.014','2015-01-01','2015-03-31'
exec table_wwzc '06.018','2015-01-01','2015-03-31'
exec table_wwzc '01.138','2015-01-01','2015-03-31'
