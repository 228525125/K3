...
select isnull(sum(case when datediff(day,jhrq,dhrq)>1 or (dhrq='' and datediff(day,jhrq,getDate())>1) then id end),0) as 'wxoverr',
...
execute count_wxjq '2012-12-01','2012-12-31' 
...
select * from ICShop_SubcOut a left join ICShop_SubcOutEntry b on a.FInterID=b.FInterID where FBillNo = 'wwzc380'
