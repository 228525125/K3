--drop procedure count_task_stjgrk drop procedure list_task_stjgrk drop procedure list_task_stjgrk_count

create procedure count_task_stjgrk
@FUserID varchar(50)
as 
begin
SET NOCOUNT ON 
...
create procedure list_task_stjgrk
@FUserID varchar(50),
@query varchar(50),
...
--list_task_stjgrk_count--
create procedure list_task_stjgrk_count
@FUserID varchar(50),
@query varchar(50),
@begindate varchar(10),
@enddate varchar(10)
...
execute task_stjgrk 'chenxian'

execute list_task_stjgrk 'chenxian','','2011-01-01','2011-11-30'

execute list_task_stjgrk_count 'chenxian','','2011-01-01','2011-11-30'
