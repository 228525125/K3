--drop procedure count_task_cprk drop procedure list_task_cprk drop procedure list_task_cprk_count

create procedure count_task_cprk
@FUserID varchar(50)
as 
begin
SET NOCOUNT ON 
...
--list_task_cprk--
create procedure list_task_cprk
@FUserID varchar(50),
@query varchar(50),
...
--list_task_cprk_count--
create procedure list_task_cprk_count
@FUserID varchar(50),
@query varchar(50),
@begindate varchar(10),
@enddate varchar(10)
...
execute task_cprk 'chenxian'

execute list_task_cprk 'chenxian','','2011-01-01','2011-11-30'

execute list_task_cprk_count 'chenxian','','2011-01-01','2011-11-30'
