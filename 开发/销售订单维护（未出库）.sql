--drop procedure portal_list_xsdd drop procedure portal_list_xsdd_count
...
order by datediff(day,u1.FDate,getDate()) desc
...
execute portal_list_xsdd '','2011-12-29','2099-12-31','null','null'
