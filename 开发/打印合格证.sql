...
Insert Into #temp(FBillNo,FName,FHelpCode,FModel,FNumber,FBatchNo,FUser,FDate,FICMOBillNo,FNote,LH,EX
)
select a.FBillNo,i.FName,i.FHelpCode,i.FModel,i.FNumber,a.FBatchNo,u.FFullNumber as FUser,Convert(char(10),a.FDate,120) as FDate,v.FICMOBillNo,isnull(s.FNote,''),'',i.FApproveNo
from ICQCBill a 
...
select o.FBillNo,i.FName,i.FHelpCode,i.FModel,i.FNumber,o.FGMPBatchNo,'0225' as FUser,Convert(char(10),getDate(),120) as FDate,o.FBillNo as FICMOBillNo,isnull(s.FNote,''),o.FHeadSelfJ0184,i.FApproveNo
from ICMO o 
left join (select a.FInterID,b.FEntryID,MIN(b.FEntrySelfS0161) as FNote from SEOrder a left join SEOrderEntry b on a.FInterID=b.FInterID group by a.FInterID,b.FEntryID) s on s.FInterID=o.FOrderInterID and s.FEntryID=o.FSourceEntryID
