...
exec list_scrw_wlxh_querySub '27998','','2015-01-01','2015-04-10','',''
...
select * from icmo where FBillNo='work027998'
...
and b.FAuxQtyScrap > 0                              --单位用量必须大于0
and d.FNumber <> '06.07.0135' and d.FNumber<>'06.07.0045' and d.FNumber<>'06.07.0040'      --不考虑外购称重的半成品
and a.FPlanFinishDate>='2014-02-01' and a.FPlanFinishDate<='2015-04-10'
AND (a.FBillNo like '%27998%')
order by a.FBillNo,d.FNumber
