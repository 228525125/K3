...
,bhgsl decimal(28,4) default(0)         --成品不合格数量
,hbsl decimal(28,4) default(0)          --工序汇报
)

Insert Into #Data(djbh,djrq,cpdm,cpmc,cpgg,cpph,jhsl,sqsl,hgsl,rksl,wldm,wlmc,wlgg,dwyl,llsl,bfsl,tlsl,zzpsl,djzt,bhgsl,hbsl
)
...
,(b.FAuxStockQty - b.FDiscardAuxQty + ISNULL(-e.FQty,0) - case when g.FProChkMde=352 then ISNULL(a.FAuxStockQty,0)*b.FAuxQtyScrap else ISNULL(c.FQty,0)*b.FAuxQtyScrap end) as 'zzpsl',
case when a.FStatus=0 then '计划' when a.FStatus=5 then '确认' when a.FStatus=1 or a.FStatus=2 then '下达' when a.FStatus=3 then '结案' else '' end as 'djzt',a.FQtyForItem+a.FQtyScrap as 'bhgsl',h.hbsl
FROM ICMO a 
...
exec list_scrw_wlxh '','2013-07-01','2013-07-31',1
...
--and a.FStatus in (1,2)        --下达状态
and d.FNumber <> '06.07.0135' and d.FNumber<>'06.07.0045' and d.FNumber<>'06.07.0040'      --不考虑外购称重的半成品
and a.FBillNo = 'WORK024529'



execute list_scrw_wlxh '24529','2013-04-01','2013-07-31', 0
